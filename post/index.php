...
<meta property="og:description"        content="Beka z pogan - Najlepszy humor w internecie!" />
<?
error_reporting(0);
if(isset($_GET["id"])){
      $id=$_GET["id"];
...
$query = "SELECT id, title, host, stars, type FROM posts  WHERE id = " . $id;
$total = @mysqli_num_rows($data); 
$result = mysqli_query($connection, $query);
while($r = @mysqli_fetch_assoc($result)) { 
echo '<meta property="og:url"                content="http://bekazpogan.pl/post/'. $id .'" />';
echo '<meta property="og:title"              content="' . $r["title"] . '" />';
echo '<meta property="og:image"              content="' . $r["host"] . '" />';
}
?>
<meta property="og:image:width" content="616" />	<meta property="og:image:height" content="313" />
...
ctx.moveTo(1,3);
ctx.lineTo(parseInt($('#t". $r['id'] ."').css('width'))*1.1+110,3);
ctx.lineTo(parseInt($('#t". $r['id'] ."').css('width'))*1.1+30,47);
ctx.lineTo(3,47);
ctx.lineTo(3,3);
...
echo '<div class="fb-comments" data-colorscheme="dark" data-href="http://bekazpogan.pl/post/' . $id . '" data-numposts="5"></div>';
include("../ad3.php");
?>
